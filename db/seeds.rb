...
travel1 = Travel.create!(country: "スウェーデン", region: "ストックホルム", city:"", travel_plan: "羽田空港からフランスのシャルルドゴール空港に行き、シャルルドゴール空港からスウェーデンのアーランダー空港に到着", user_id: user1.id)
travel2 = Travel.create!(country: "日本", region: "沖縄", city: "", travel_plan: "やんばるCODEから歩いて15分くらいのところにある定食屋さん", user_id: user2.id)
...
#  content: "ストックホルムの旧市街でガムラスタンの街並みが気に入っています。魔女の宅急便のモデルにもなった街です。スウェーデンに訪れた時は必ず行きます。"

# content: "沖縄にある最強食堂という定食屋さんの唐揚げ定食が好きです。",
